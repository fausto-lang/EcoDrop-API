...
export default function Contabilidad() {
  ...
  return (
    <div style={{ padding: "30px", fontFamily: "sans-serif" }}>
      ...
      <form onSubmit={enviarDatos} style={{ display: "flex", flexDirection: "column", gap: "15px", maxWidth: "400px", marginTop: "20px" }}>
        
        <div>
          <label style={{ fontWeight: "bold", display: "block", marginBottom: "5px" }}>ID del Usuario:</label>
          <input 
            type="number" 
            value={usuarioId} 
        ...
        <div>
          <label style={{ fontWeight: "bold", display: "block", marginBottom: "5px" }}>ID del Tipo de Residuo:</label>
          <input 
            type="number" 
            value={residuoId} 
        ...
        <div>
          <label style={{ fontWeight: "bold", display: "block", marginBottom: "5px" }}>Kilos Reciclados:</label>
          <input 
            type="number" 
            step="0.1"
            value={kilos} 
        ...
        <button type="submit" style={{ padding: "12px", backgroundColor: "#52b788", color: "white", border: "none", borderRadius: "5px", fontWeight: "bold", cursor: "pointer", fontSize: "16px" }}>
          Guardar Registro
        </button>
      </form>
    </div>
